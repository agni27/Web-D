...
// console.log(typeof(jokes))
  ...
  console.log(num)
  let joke=jokes[num];
  let a=document.getElementsByClassName("meow")[0];
  a.innerHTML= joke
  setTimeout(function() {
  location.reload();
}, 2000);
